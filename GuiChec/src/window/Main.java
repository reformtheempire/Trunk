...
public class Main {
	...
	private void initialize() {
		...
		checFrame.setBounds(100, 100, 664, 409);
		...
		btnChec.setBounds(279, 184, 85, 25);
		...
		txtDomain.setBounds(122, 148, 404, 25);
		searchPanel.add(txtDomain);
		txtDomain.setColumns(10);

		specificWhoisServer = new JTextField();
		specificWhoisServer.setFont(new Font("Tahoma", Font.ITALIC, 12));
		specificWhoisServer.setText("Coming Soon...");
		specificWhoisServer.setEditable(false);
		specificWhoisServer.setToolTipText("OPTIONAL: Specify a WHOIS Server (e.g: whois.nic.example)");
		specificWhoisServer.setBounds(522, 289, 110, 25);
		...
		lblAdvancedSpecifyWhois.setBounds(327, 294, 211, 15);
		...
		domainNameResult.setBounds(100, 12, 261, 25);
		...
		whoisserverResultField.setBounds(369, 12, 261, 25);
		...
		scrollPane.setBounds(12, 44, 618, 288);
